...
from app.core.common.patterns import ANSI_ESCAPE_PATTERN
from app.core.common.types import LogConfig, Quota
...
class ApplicationLogger:
    ...
    def trace(
        ...
        if not hasattr(request, "client") or request.client is None:
            host, port = self.__config.host, self.__config.port
        else:
